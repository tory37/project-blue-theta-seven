...
Blue Theta Seven is a system-first game where players build the battlefield as they play. It combines the strategic preparation of a TCG with the tactical movement of a wargame.
...
- [Systems: Combat](./systems/combat.md) - Dice resolution and stats.
- [World: Board & Terrain](./world/board-terrain.md) - Hexagons and map building.
- [World: Entities](./world/entities.md) - Characters and upgrades.
- [Meta: Progression](./meta/progression.md) - Unlocks and game modes.
